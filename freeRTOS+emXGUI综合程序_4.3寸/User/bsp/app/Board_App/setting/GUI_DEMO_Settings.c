...
{ 
   switch(msg){
      ...
      case WM_PAINT:
      {
        ...
        DrawText(hdc, L"野火-F767挑战者", -1, &rc, DT_VCENTER|DT_RIGHT);//绘制文字(居中对齐方式) 
        HLine(hdc, rc.x, rc.y+rc.h, rc.x+470);
        ...
        DrawText(hdc, L"512KB+32MB", -1, &rc, DT_VCENTER|DT_RIGHT);//绘制文字(居中对齐方式) 
        HLine(hdc, rc.x, rc.y+rc.h, rc.x+470);
        ...
        DrawText(hdc, L"STM32F767", -1, &rc, DT_VCENTER|DT_RIGHT);//绘制文字(居中对齐方式) 
        HLine(hdc, rc.x, rc.y+rc.h, rc.x+470);
